...
class _HerbalState extends State<Herbal> {
  ...
  @override
  void initState() {
    dbProvider.getHarbalUnani().then((data) {
      setState(() {
        countries = data;
    ...
    //click events
    String userActivity = 'User is in Herbal tab';
    String page = 'Herbal';
              ...
              children: [
                Container(
                  child: SmartRefresher(
                    ...
                    onRefresh: () async {
                      final res = await dbProvider.getHarbalUnani();
                      setState(() {
                              ...
                              return GestureDetector(
                                ...
                                child: _isSwitchOn == false
                                    ? BuildCardOval(
                                        ...
                                        // thumbLink:
                                        //     'https://www.drug-international.com/uploads/product_images/1569397505Abiret%20250mg%20-%20Carton%20Pic.png',
                                      )
                                    : BuildCardArrow(
                                        color: Color(0xffdd081d),
                                        drugIcon: 'https://www.freeiconspng.com/thumbs/medical-icon-png/pills-blue-icon-6.png',
