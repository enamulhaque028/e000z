...
class ShortListPage extends StatefulWidget {
  @override
  ShortListPageState createState() => ShortListPageState();
}

class ShortListPageState extends State<ShortListPage> {
  DBProvider dbProvider = DBProvider();
  DBService dbService = DBService();
  List<AddToShortList> data = [];
  List<AddToShortList> displayData = [];
  ...
  void initState() {
    ...
    //click events
    String userActivity = 'User is in Short List page';
    String page = 'Short List';
            ...
            actions: [
              ...
              FlatButton(
                ...
                onPressed: () async {
                  ...
                  //click events
                  String userActivity =
                      'Deleted "$productName" from Short List';
                  String page = 'Short List';
                  String date = DateTime.now().toString();
                  dbProvider.addToClickEvent(userActivity, page, date);

                  //delete product
                  dbProvider.deleteProductFromShortList(productNo).then((value) {
                  ...
                  final res = await dbProvider.getProductsFromShortList();
                  setState(() {
                    displayData = res;
                  });
                },
