...
class _OncologyState extends State<Oncology> {
  ...
  @override
  void initState() {
    dbProvider.getProductsByCategory('O').then((data) {
      setState(() {
        countries = data;
    ...
    //click events
    String userActivity = 'User is in Oncology tab';
    String page = 'Oncology';
      ...
      body: isLoading
          ...
          : Container(
              child: SmartRefresher(
                ...
                onRefresh: () async {
                  final res = await dbProvider.getProductsByCategory('O');
                  setState(() {
      ...
      floatingActionButton: Align(
        ...
        child: FloatingActionButton(
          onPressed: () {
            ...
            //click events
            String userActivity = 'Went to Cart page from Oncology';
            String page = 'Oncology';
            String date = DateTime.now().toString();
            dbProvider.addToClickEvent(userActivity, page, date);
          },
