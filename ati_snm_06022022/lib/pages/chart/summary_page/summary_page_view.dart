  ...
  void initState() {
    ...
    DBProvider().getTicketStatusByDate(widget.days).then((value) {
      setState(() {
        ...
        statusData.length == 4 ? Container() : statusData.sort((a, b) => a.tKTSTUSID.compareTo(b.tKTSTUSID));
      });
    }).then((value) {
                      ...
                      elevation: 0,
                        ...
                        child: Row(
                          children: [
                            ...
                            Container(color: Colors.green, height: (statusData.length * 62).toDouble(), width: 1),
                            Expanded(
                              child: ListView.builder(
                                ...
                                itemBuilder: (BuildContext context, int index) {
                                  ...
                                  return InkWell(
                                    onTap: (){
                                      if(ticketStatusId == '1' || ticketStatusId == '2' || ticketStatusId == '3' || ticketStatusId == '4' || ticketStatusId == '5' || ticketStatusId == '9'){
                        ...
                        child: Card(
                          ...
                          child: Row(
                            children: [
                              ...
                              Container(color: Color(PrimaryColor), height: (priorityData.length * 62).toDouble(), width: 1),
                              Expanded(
                                child: ListView.builder(
                                  physics: const NeverScrollableScrollPhysics(),
                                  shrinkWrap: true,
                                  ...
                                  itemBuilder: (BuildContext context, int index) {
                                    ...
                                    return InkWell(
                                      onTap: (){
                                      if(ticketPriorityId == '1' || ticketPriorityId == '2' || ticketPriorityId == '3' || ticketPriorityId == '4' || ticketPriorityId == '5'){
                                        Navigator.push(context, MaterialPageRoute(
