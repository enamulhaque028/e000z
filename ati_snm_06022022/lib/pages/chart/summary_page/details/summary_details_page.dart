...
class SummaryDetailsPage extends StatefulWidget {
  ...
  @override
  _SummaryDetailsPageState createState() => _SummaryDetailsPageState();
}
...
class _SummaryDetailsPageState extends State<SummaryDetailsPage> {
  ...
  @override
  void initState() {
    widget.ticketPriorityId == '' ? dbService.getTicketsByStatus(widget.ticketStatusId, widget.passDate).then((data) {
      setState(() {
        clients = data;
        displayClients = clients;
        isLoading = false;
      });
    }) : dbService.getTicketsByPriority(widget.ticketPriorityId, widget.passDate).then((data) {
      setState(() {
        clients = data;
        displayClients = clients;
        isLoading = false;
