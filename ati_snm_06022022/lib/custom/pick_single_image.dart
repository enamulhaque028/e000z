...
class PickSingleImages extends StatefulWidget {
  final String imageType;
  static String profileImgPath = '';
  static String signatureImgPath = '';

  const PickSingleImages({Key key, @required this.imageType}) : super(key: key);
  // static List base64ImageList = [];
  @override
  _PickSingleImagesState createState() => _PickSingleImagesState();
}

class _PickSingleImagesState extends State<PickSingleImages> {
  List<Object> images = [];
  ...
  void getFileImage(int index) async {
    _imageFile.then((file) async {
      ...
      setState(() {
        ...
        //     ? PickSingleImages.base64ImageProfile = base64Encode(imageBytes)
        //     : PickSingleImages.base64ImageSignature = base64Encode(imageBytes);
        widget.imageType == 'profile'
            ? PickSingleImages.profileImgPath = file.path
            : PickSingleImages.signatureImgPath = file.path;
        // print(PickSingleImages.base64ImageProfile);
        images.replaceRange(index, index + 1, [imageUpload]);

        //PickSingleImages.base64ImageList = List();
        // PickSingleImages.base64ImageList.add(base64Image);
        ...
        child: GridView.count(
          ...
          children: List.generate(images.length, (index) {
            if (images[index] is ImageUploadModel) {
              ...
              // PickSingleImages.base64Image = base64Encode(
              ...
              return Container(
                ...
                child: Stack(
                  children: <Widget>[
                    ...
                    //     // log(PickSingleImages.base64Image);
