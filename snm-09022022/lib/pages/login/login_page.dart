                          ...
                          if (validateAndSave()) {
                            ...
                            apiService.login(loginRequestModel).then((value) async {
                              if (value.toString().isNotEmpty && value != null) {
                                ...
                                String userCode = value['details']['SAUSERS_ID'].toString();
                                String clientsId = value['details']['CLIENTS_ID'].toString();
                                String userName = value['details']['USRS_FNAME'].toString();
                                String userEmail = value['details']['USER_EMAIL'].toString();

                                String companyId = value['details']['COMPANY_ID'].toString();
                                String cBranchId = value['details']['CBRANCH_ID'].toString();
                                String cobUnitId = value['details']['COBUNIT_ID'].toString();
                                String ptgUnitId = value['details']['PTGUNIT_ID'].toString();
                                //print(LoginPage.userCode);

                                String saUserID = value['details']['SAUSERS_ID'].toString();
                                String employeeId = value['details']['EMPLOYE_ID'].toString();
                                String acpInfoID = value['details']['ACPINFO_ID'].toString();
                                ...
                                int pMaverCode = int.parse(value['user_details']['P_MAVERCODE']);
                                ...
                                if (pMaverCode == 39) {
                                  ...
                                  Navigator.pushReplacement(
                                    context,
                                    MaterialPageRoute(builder: (BuildContext ctx) =>ChartPage()),
                                  );
