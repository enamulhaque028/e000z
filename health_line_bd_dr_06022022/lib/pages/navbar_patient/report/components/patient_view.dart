...
class _PatientViewState extends State<PatientView> {
  String formattedDate(String visitDate) {
    ...
    // var pos = visitDate.lastIndexOf('-');
    // formatDate = (pos != -1) ? visitDate.substring(0, pos) : visitDate;
    return formatDate;
  }
      ...
      children: [
        Row(
          children: [
            ...
            //   lineHeight: 75,
            //   text:
            //       widget.visitDate == '' ? '' : formattedDate(widget.visitDate),
            //   lineColor: cViolet,
            //   circleBorderColor: cViolet,
            // ),
            Container(
              padding: EdgeInsets.only(left: 4, right: 5, top: 10),
              height: 200,
              width: width - 58,
              child: Card(
                elevation: 4.0,
        ...
        Positioned(
          right: 15,
          top: widget.index + 1 == widget.listLength ? 2 : -11,
          child: Container(
